...
> ⚠️ **OKLCH en pantallas P3 (Mac Retina, iPhone)**: Los navegadores modernos renderizan OKLCH en el gamut P3, lo que amplifica la saturación de colores de marca. Al agregar o modificar colores visibles (primary, accent, badges), aplicar el proceso de **Calibración OKLCH** documentado en `OKLCH_CALIBRATION.md`. No hacerlo produce inconsistencias entre Figma y el browser.
